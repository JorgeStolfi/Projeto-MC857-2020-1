...
def valor_mem_para_valor_SQL(nome, val_mem, tipo_mem, tipo_SQL, nulo_ok):
  ...
  {tipo_mem} é uma subclasse de {Objeto}, o 
  {tipo_SQL} deve ser 'TEXT'; e o objeto {val_mem} é substituído pelo seu
  identificador "{L}-{NNNNNNNN}".
  ...
  return conversao_sql_IMP.valor_mem_para_valor_SQL(nome, val_mem, tipo_mem, tipo_SQL, nulo_ok)
...
def valor_SQL_para_valor_mem(nome, val_SQL, tipo_SQL, tipo_mem, nulo_ok, id_para_objeto):
  ...
  convenção 0={False}, 1={True}. Se {tipo_mem} é uma subclasse de {Objeto}, o 
  ...
  return conversao_sql_IMP.valor_SQL_para_valor_mem(nome, val_SQL, tipo_SQL, tipo_mem, nulo_ok, id_para_objeto)
...
def dict_mem_para_dict_SQL(dic_mem, cols, falta_ok):
  ...
  correspondente. """
  return conversao_sql_IMP.dict_mem_para_dict_SQL(dic_mem, cols, falta_ok)
...
def dict_SQL_para_dict_mem(dic_SQL, cols, falta_ok, id_para_objeto):
  ...
  return conversao_sql_IMP.dict_SQL_para_dict_mem(dic_SQL, cols, falta_ok, id_para_objeto)
