...
def gera(id_usuario, atrs, admin, texto_bt, post_url):
  ...
  O formulário terá um botão "submit" com texto {texto_bt} e ação POST
  redirecionando para {post_url}."""
  return html_form_dados_de_usuario_IMP.gera(id_usuario, atrs, admin, texto_bt, post_url)
