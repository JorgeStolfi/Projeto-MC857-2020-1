...
def gera(ids, cpr, trc, excluir, trocar):
  ...
  Se {cpr} não é {None}, todas as poltronas devem pertencer ao pedido de
  compra compra {cpr}. Nesse caso {trc} deve ser {None} e {comprar} e
  {alterar} devem ser {False}. Ale disso, se {excluir} for {True}, a
  compra deve estar em aberto, e cada poltrona terá um botão "Excluir"
