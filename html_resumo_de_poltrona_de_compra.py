...
def gera(pol, id_compra, ver, excluir, trocar):
  ...
  Se {trocar} for {True}, a linha terá um botão "Trocar" que, quando
  clicado, emitirá o comando HTTP "trocar_poltrona" com
  argumentos {'id_poltrona': id_poltrona, 'id_compra': id_compra}. 
  (Normalmente, este botão só deveria ser solicitado se o pedido
  de compra ainda estiver em aberto, e o dono da sessão corrente
  for um cliente comum que é o dono do pedido de compra.) 
  ...
  return html_resumo_de_poltrona_de_compra_IMP.gera(pol, id_compra, ver, excluir, trocar)
