...
def verifica_valor(rotulo, val_mem, tipo_mem, val_SQL, tipo_SQL, nulo_ok):
  ...
  val_SQL_cmp = conversao_sql.valor_mem_para_valor_SQL(rotulo, val_mem, tipo_mem, tipo_SQL, nulo_ok)
...
verifica_valor("compra",        cpr1,     type(cpr1),     cpr1_id,  'TEXT',      False )
...
def verifica_dict(rotulo, dic_mem, falta_ok, dic_SQL):
  ...
  dic_SQL_cmp = conversao_sql.dict_mem_para_dict_SQL(dic_mem, colunas, falta_ok)
  ...
  dic_mem_cmp = conversao_sql.dict_SQL_para_dict_mem(dic_SQL, colunas, falta_ok, tabelas.id_para_objeto)
